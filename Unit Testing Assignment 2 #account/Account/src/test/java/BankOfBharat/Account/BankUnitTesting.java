...
public class BankUnitTesting {
	...
	//checking initial balance test case
	...
	public void copyResultFile(String RequestID) throws Exception{
		...
		try {
			Files.copy(Paths.get("C:\\Users\\lenovo\\eclipse-workspace\\Account\\test-output\\emailable-report.html"), Paths.get("./"+RequestID+"/Result.html"),StandardCopyOption.REPLACE_EXISTING);	}
		catch (IOException e) {
